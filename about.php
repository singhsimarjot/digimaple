...
<div class="pager-sec text-right pb-30">
	...
	<div class="services-section">
		<div class="container">
			<div class="row team-carousel">
				<div class="col-lg-4">
					<div class="tema-col">
						<img src="./images/GurwinderSingh.jpg" alt="">
						<div class="team-caption">
							<h3><a href="#" title="">Gurwinder Singh</a></h3>
							<span>Director</span>
				...
				<div class="col-lg-4">
					<div class="tema-col">
						<img src="./images/SimarjotSingh.jpg" alt="">
						<div class="team-caption">
							<h3><a href="#" title="">Simarjot Singh</a></h3>
	...
	<div class="container">
		<div class="partners-logo">
			<div class="partner-col" style="background-color: #ffffff;"  >
				<img src="./images/brpaper.png" alt=""  width="100"/>
			</div><!--partner-col end-->
			<div class="partner-col">
				<img src="./images/FOAM-TO-LOGO-1-2048x977.png" alt="">
			</div><!--partner-col end-->
			<div class="partner-col" style="background-color: #ffffff;">
				<img src="./images/cropped-Dobry-Studios-Logos-Black-128x43.png" alt="">
			</div><!--partner-col end-->
			<div class="partner-col">
