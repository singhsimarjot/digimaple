    ...
    <div class="page-content">
        ...
        <div class="container">
            <div class="main-banner-text title-hd max-width-80">
                ...
                <h1>Web Development <span></span></h1>
            </div><!--main-banner-text end-->
            <div class="service-details pb-0">
                <div class="row">
                    <div class="col-lg-9">
                        <div class="service-details-content">
                            <img src="./images/web2.jpg" alt="" class="img-fluid">
                            <p>We recognise the importance of web development in the creation of successful
                                digital goods. A well-designed and built website, in our opinion, may help
                                businesses attract and keep consumers, build brand reputation, and increase
                                revenue. Our professional web development team collaborates with our customers
                                to design and construct bespoke websites that match their specific demands and
                                objectives. To find chances for development and improvement, we perform a
                                detailed investigation of the client's business, target audience, and
                                competitors. Wireframes and prototypes are created utilising industry-standard
                                tools and techniques to build intuitive and engaging user interfaces. Our web
                                designers employ cutting-edge technology and programming languages to produce
                                high-quality websites that are not only functional but also scalable and secure.
                            </p>
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="wk-text">
                                        ...
                                        <p> We first analyze the purpose of the website and find measurable
                                            goals that align with the purpose.</p>
                                    </div><!--wk-text end-->
                                </div>
                                <div class="col-lg-4">
                                    <div class="wk-text">
                                        ...
                                        <p>Create an attractive and intuitive design that is easy to navigate,
                                            with a layout that emphasizes the most important information.</p>
                                    </div><!--wk-text end-->
                                </div>
                                <div class="col-lg-4">
                                    <div class="wk-text">
                                        ...
                                        <p>Improve the performance across devices and browsers. Put in place security
                                            measures to safeguard the website and its visitors like hacking and viruses.</p>
                                    </div><!--wk-text end-->
                                </div>
                            </div>
                            <p>Front-end development are focused on the interactive design involves creating a
                                clean, intuitive layout that is easy to navigate,cross-platform support. Backend
                                development focuses on the server-side of web applications, which includes the
                                logic, database, and APIs that enable the frontend to interact with the backend.
                            </p>
                            <p>When it comes to developing a website, there are several key aspects to consider.
                                Here are some key areas to focus on:</p>
                            <ul class="sv-links">
                                <li>Branding</li>
                                <li>Accessibility</li>
                                <li>Improve visibility on search engine and attract more traffic</li>
